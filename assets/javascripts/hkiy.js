...
var _tumblr_background_imager = require('./lib/tumblr_background_imager.js');
...
(function () {
  ...
  function initButton() {
    ...
    if (_jsCookie2.default.get('hkiy') !== undefined) {
    ...
    $.ajax({
      ...
      success: function success(res) {
        if (res.status === 200) {
          ...
          // expiresは、次の日の0時
          var _d = new Date();
          var next0Oclock = new Date(_d.getFullYear(), _d.getMonth(), _d.getDate() + 1, 0, 0, 0);
          _jsCookie2.default.set('hkiy', 'true', { expires: next0Oclock });
  ...
  // デバッグ用関数
  function debug() {
    _jsCookie2.default.remove('hkiy');
  }
})();

},{"./lib/tumblr_background_imager.js":2,"jquery":3,"js-cookie":4}],2:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
var TumblrImager = exports.TumblrImager = {
  ...
  rotateUrl: function rotateUrl(callback) {
    var url = this.urls.shift();
    callback(url);
    this.urls.push(url);
  },

  shuffleUrls: function shuffleUrls() {
